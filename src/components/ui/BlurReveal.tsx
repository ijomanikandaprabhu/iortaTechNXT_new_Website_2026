 ...
 *    they are the same library, and adding both would ship it twice
 *  - Tailwind utilities replaced with project CSS classes, since this
 *    project uses design tokens rather than Tailwind
 */
        ...
        >
          ...
          {children &&
            children.split(" ").map((word, wordIndex, wordsArray) => (
              <span key={`word-${wordIndex}`} className="u-word" aria-hidden="true">
